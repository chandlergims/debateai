    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 404) {
          ...
          const mockTopics = [
            { _id: '1', title: 'Is AI consciousness possible?', votes: 42, createdAt: new Date().toISOString(), createdBy: '', votedBy: [] },
            { _id: '2', title: 'Should social media be regulated?', votes: 38, createdAt: new Date().toISOString(), createdBy: '', votedBy: [] },
            { _id: '3', title: 'Is universal basic income viable?', votes: 27, createdAt: new Date().toISOString(), createdBy: '', votedBy: [] },
          ];
